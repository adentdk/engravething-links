...
export default function Layout(props: {
  ...
  return (
    <>
      <main>
        <section className="hero min-h-screen bg-[url(https://firebasestorage.googleapis.com/v0/b/engravethingid.appspot.com/o/assets%2Fhero-1.webp?alt=media&token=6e05bbb0-5a7a-458c-a68a-402ddbbad492)]">
