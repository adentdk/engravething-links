...
export default async function Page() {
  ...
  return (
    <section className="relative py-16 bg-gradient-to-b from-black/90 backdrop-blur-sm via-gray-800 to-gray-700">
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 2xl:grid-cols-5">
          {products.map((product, productIndex) => (
            <div className="card card-compact bg-base-100 shadow-xl" key={'product' + productIndex}>
              <figure className="">
